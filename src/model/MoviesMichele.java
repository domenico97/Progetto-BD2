...
public class MoviesMichele {
	...
	public static ArrayList<Document> genreAverageForActor(String actor) throws UnknownHostException {
		...
		List<? extends Bson> pipeline = Arrays.asList(
				...
				.append("$match", new Document()
						.append("actors", new BsonRegularExpression(".*"+actor+".*", "i"))
						), 
				new Document()
	...
	public static ArrayList<Document> getFilm(String film) throws UnknownHostException {
		...
		ArrayList<Document> list = collection.find(query).projection(projection).sort(sort).limit(limit).into(new ArrayList<>());
